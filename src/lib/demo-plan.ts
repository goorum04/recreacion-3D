import type { FloorPlanData } from './floor-plan-types';
...
export const DEMO_PLAN: FloorPlanData = {
  ...
  doors: [
    { x: 0, z: 2, width: 0.9, rotation: Math.PI / 2 }, // main entrance (on left wall, spans along Z)
    { x: 6, z: 2.5, width: 0.9, rotation: Math.PI / 2 }, // living <-> kitchen
    { x: 3, z: 5, width: 0.9, rotation: 0 }, // living <-> hallway
    { x: 4, z: 6.2, width: 0.8, rotation: Math.PI / 2 }, // hallway <-> bedroom1
    { x: 8, z: 6.2, width: 0.8, rotation: Math.PI / 2 }, // hallway <-> bedroom2
    { x: 6, z: 7, width: 0.7, rotation: 0 }, // hallway <-> bathroom
  ],
  windows: [
    { x: 3, z: 0, width: 2, sillHeight: 0.9, height: 1.3, rotation: 0 },
    { x: 11, z: 2.5, width: 1.5, sillHeight: 0.9, height: 1.2, rotation: Math.PI / 2 },
    { x: 2, z: 9, width: 1.5, sillHeight: 0.9, height: 1.2, rotation: 0 },
    { x: 11, z: 8, width: 1.2, sillHeight: 0.9, height: 1.2, rotation: Math.PI / 2 },
  ],
  furniture: [
